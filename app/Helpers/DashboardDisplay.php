 ...
 * @param \PDO $db
 */
// function renderOrderRow(array $order, \PDO $db) pour afficher une ligne de commande dans le dashboard utilisateur avec les détails et la modale de suivi
...
?>
    ...
    <!-- Modale de détails avec la Chronologie -->
