...
<div class="d-flex wrapperstyle">       
     <aside class="sidebar flex-shrink-0">
            <div class="sidebar-header">
                <h2>Vite & Gourmand <span>ADMIN</span></h2>
            </div>
            ...
            <nav class="sidebar-menu">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a href="?page=dashboard-admin" class="nav-link <?php echo $current_page === 'dashboard-admin' ? 'active' : ''; ?>">
                    ...
                    <!-- 4. Administration (Spécifique Admin) -->
                    <li class="nav-item">
                        <a href="?page=rh-admin" class="nav-link <?php echo $current_page === 'rh-admin' ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item">
                        <a href="?page=stats-admin" class="nav-link <?php echo $current_page === 'stats-admin' ? 'active' : ''; ?>">
