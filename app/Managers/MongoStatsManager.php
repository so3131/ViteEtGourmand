...
// class MongoStatsManager pour gérer les statistiques dans MongoDB
class MongoStatsManager
{
    private ?Client $mongoClient = null;
    // function constructeur pour initialiser la connexion à MongoDB
    ...
    public function getSalesFilteredFromMongoDB($dateDebut = null, $dateFin = null, $menuId = null): float
    {
        ...
        try {
            ...
            // Filtre par menu si un ID de menu est fourni
            if (!empty($menuId)) {
                $pipeline[] = [
                    '$match' => [
                        'articles' => [
    ...
    // function pour récupérer le nombre total de régimes depuis MongoDB
