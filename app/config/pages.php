...
'existante' => ['home', 'login', 'signin', 'logout', 'search', 'details-menu', 'order-menu', 'order-success','ajax-frais-livraison', 'filter', 'contact', 'contact-success', 'mention', '404', 'error-ban', 'forgot-password', 'reset-password', 'update-profil', 'dashboard-user', 'erase-order', 'dashboard-employee', 'conflict-employee', 'moderation-employee', 'dashboard-admin', 'stats-admin', 'rh-admin', 'ban-user-admin', 'ban-action-admin', 'moderation-admin', 'conflict-admin', 'tickets-admin', 'delete-tickets-admin', 'unban-action-admin'],
...
// Utilisateur
'user' => ['dashboard-user', 'update-profil',  'order-menu', 'order-success','erase-order','ajax-frais-livraison'],
